...
public class SeckillGoodsPushTask {
    ...
    public void loadSecKillGoodsToRedis() {
        ...
        for (Date dateMenu : dateMenus) {
            ...
            String redisExtendName = DateUtil.date2Str(dateMenu);
            ...
            Set keys = redisTemplate.boundHashOps(SECKILL_GOODS_KEY + redisExtendName).keys();
            ...
            for (SeckillGoods seckillGoods : seckillGoodsList) {
                //商品详情
                redisTemplate.opsForHash().put(SECKILL_GOODS_KEY + redisExtendName, String.valueOf(seckillGoods.getId()), seckillGoods);
                //庫存
